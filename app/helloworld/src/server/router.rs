...
use axum::{
    extract::Query, extract::Request, middleware::Next, response::Json, routing::get, Router,
};
use tower_http::{
...
impl HttpServer {
    ...
    pub fn create_router_with_config(&self, tracing_config: TracingConfig) -> Router {
        ...
        Router::new()
            ...
            .route("/id", get(hello_service.clone().generate_id))
            .route("/user", get(hello_service.clone().get_user))
            // 应用中间件层
            .layer(
